...
// --- EVEN MORE NAUGHTY TRUTHS ---
  { type: "Truth", text: "Have you ever had a completely inappropriate dirty dream about me? What exactly happened in it?" },
  { type: "Truth", text: "If we were playing strip poker right now, what is the very first piece of clothing you’d want me to lose?" },
  { type: "Truth", text: "What is a completely non-sexual thing I do (like a look, a stretch, or a habit) that somehow instantly turns you on?" },
  { type: "Truth", text: "If I told you I wasn't wearing any underwear the next time we went out to dinner, how would you react?" },
  { type: "Truth", text: "What is your absolute favorite position we’ve ever been in together, and why?" },
  { type: "Truth", text: "Would you rather hook up somewhere risky where we might get caught, or have a slow, loud night in an empty house?" },
  { type: "Truth", text: "If you could only use one toy or accessory with me for the rest of our lives, what are you choosing?" },
  { type: "Truth", text: "What is the longest you've ever spent thinking about me in a naughty way during the middle of the workday?" },
  { type: "Truth", text: "What is a specific tease or move you’ve been wanting to try on me but haven't found the right moment for?" },
  { type: "Truth", text: "If I gave you a 'free pass' to do exactly one dirty thing to me right now, no questions asked, what is it?" },

  // --- EVEN MORE NAUGHTY DARES (WITH WHATSAPP PROOF) ---
  { type: "Dare", text: "Send a 'view once' WhatsApp picture resting your hand teasingly right at the waistband of your pants or underwear." },
  { type: "Dare", text: "Take an ice cube, slowly run it down your chest or stomach, and send me a 5-second video on WhatsApp." },
  { type: "Dare", text: "Send a voice note giving me a strict set of 'instructions' on what I need to do to you the next time we are alone." },
  { type: "Dare", text: "Put on one of my shirts (or your favorite oversized shirt) with absolutely nothing underneath, and send a teasing selfie." },
  { type: "Dare", text: "Send a close-up 'view once' photo of your neck or collarbone, pointing to exactly where you want me to bite or leave a mark." },
  { type: "Dare", text: "Send a voice note on WhatsApp describing the exact sound you make when you are pushed over the edge." },
  { type: "Dare", text: "Take a teasing video of yourself pulling down your zipper, buttons, or straps just one inch—and then frustratingly stopping." },
  { type: "Dare", text: "Send a WhatsApp picture of the most suggestive or phallic object in the room with you right now." },
  { type: "Dare", text: "Go to your bathroom mirror, splash a little water on your chest/shirt to make it slightly damp, and send a WhatsApp picture." },
  { type: "Dare", text: "Send me a text on WhatsApp describing exactly how you'd wake me up tomorrow morning if my hands were tied to the bed." },
  { type: "Dare", text: "Send a voice note groaning my name exactly the way you would if we were alone in the dark." },
  { type: "Dare", text: "Send a 'view once' picture of your lips parted, waiting for a kiss, but make it look as hungry as possible." },
  { type: "Truth", text: "What is the dirtiest thought you've ever had about me while we were in a public place?" },
  { type: "Truth", text: "If I was completely under your control in the bedroom for an hour, what is the very first thing you’d make me do?" },
  { type: "Truth", text: "What is a secret fantasy or kink you've been curious to try with me but haven't mentioned yet?" },
  { type: "Truth", text: "What outfit or piece of clothing of mine immediately turns you on?" },
  { type: "Truth", text: "Exactly where is your absolute favorite place on your body to be kissed or touched?" },
  { type: "Truth", text: "What was going through your mind the very first time we were intimate?" },
  { type: "Truth", text: "Have you ever touched yourself while thinking about me? What exactly were you remembering?" },
  { type: "Truth", text: "What is the most sensitive spot on my body that always gets a reaction out of you?" },
  { type: "Truth", text: "If we had to have quick sex anywhere outside of a bedroom right now, where would you want to do it?" },
  { type: "Truth", text: "What is a dirty word or phrase you secretly love hearing me say?" },

  // --- NAUGHTY DARES (WITH WHATSAPP PROOF) ---
  { type: "Dare", text: "Send a 'view once' WhatsApp picture of exactly what is underneath your clothes right now." },
  { type: "Dare", text: "Send a voice note describing in detail exactly what you want me to do to you the next time we are alone." },
  { type: "Dare", text: "Go to the bathroom, take off your shirt/top, and send a teasing mirror selfie on WhatsApp." },
  { type: "Dare", text: "Send a 5-second WhatsApp video of you slowly unbuttoning or unzipping whatever you are wearing." },
  { type: "Dare", text: "Take a close-up WhatsApp photo of your favorite physical feature on your own body and send it to me." },
  { type: "Dare", text: "Send a voice note of your heaviest breathing or a soft moan." },
  { type: "Dare", text: "Send a WhatsApp picture of the specific underwear or lingerie you want me to take off of you next." },
  { type: "Dare", text: "Send a teasing photo on WhatsApp of your bare thighs or legs." },
  { type: "Dare", text: "Take a selfie biting your lip and looking intensely into the camera, and send it right now." },
  { type: "Dare", text: "Send a WhatsApp text telling me the exact body part of mine you want in your mouth right now." },
  { type: "Dare", text: "Send a view-once WhatsApp photo of you in the shower or bath (you can hide your face if you want)." },
  { type: "Dare", text: "Send a picture of the bed, and draw a circle or arrow showing exactly where you want me to pin you down tonight." },
  { type: "Dare", text: "Send a voice note whispering the dirtiest thing you’ve ever wanted to do to me." },
  { type: "Dare", text: "Send a WhatsApp picture of your hand, and tell me exactly where you wish it was touching me right now." },
